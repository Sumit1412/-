...
demo = gr.ChatInterface(predict, chatbot=gr.Chatbot(height=500), examples=["How to train a model?", "What is Logistic Regression?"], 
                        textbox=gr.Textbox(placeholder="Ask any question Machine Learning", container=False, scale=6), title="AI Bot", 
                        description="GuardRail Enabled ChatBot", theme="default",)
